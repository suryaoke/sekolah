 ...
 <div class="content">
                                     ...
                                     <?php
                                       ...
                                       JOIN user ON activities.id_user=user.id_user
                                        ...
                                        ?>
                                         <tr>
                                             <td><?php echo $no++ ?></td>
                                             <td> <?php echo $data['judul_activities'] ?></td>
                                             <td> <?php echo substr($data['isi_activities'], 0, 50)  ?></td>
                                             <td> <?php echo date('d-m-Y', strtotime($data['tanggal_activities'])) ?></td>
                                             <td> <?php echo $data['lokasi_activities']  ?></td>
                                             <td> <?php echo $data['nama_lengkap']  ?></td>
                                             <td class="text-center"> <img width="100" src="../admin/uploads/<?php echo $data['gambar_activities'] ?>" alt=""></td>

                                             <td>
                                                 <a data-tw-toggle="modal"
                                                     data-tw-target="#update-header-footer-modal-preview-<?php echo $data['id_activities']; ?>"
                                                     class="btn btn-primary mr-1 mb-2">
                                                     <i data-lucide="edit" class="w-4 h-4"></i>
                                                 </a>
                                                 <a data-tw-toggle="modal"
                                                     data-tw-target="#delete-confirmation-modal-<?php echo $data['id_activities']; ?>"
                                         ...
                                         <!-- BEGIN: Modal Update -->
                                         <div id="update-header-footer-modal-preview-<?php echo $data['id_activities']; ?>" class="modal"
                                             tabindex="-1" aria-hidden="true">
                                             <div class="modal-dialog">
                                                 <div class="modal-content"> <!-- BEGIN: Modal Header -->
                                                     <div class="modal-header">
                                                         <h2 class="font-medium text-base mr-auto">Ubah Data activities</h2>

                                                     </div> <!-- END: Modal Header --> <!-- BEGIN: Modal Body -->
                                                     <form action="activities/proses_ubah.php" method="POST"
                                                         enctype="multipart/form-data" id="myForm3">

                                                         <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                                             <input type="hidden" name="id_activities" value="<?php echo $data['id_activities']; ?>">
                                                             <div class="col-span-12 sm:col-span-12"> <label for="modal-form-1"
                                                                     class="form-label">Judul</label>
                                                                 <input id="modal-form-1" type="text"
                                                                     name="judul_activities" class="form-control"
                                                                     placeholder="Judul" value="<?php echo $data['judul_activities']; ?>">

                                                             </div>
                                                             <div class="col-span-12 sm:col-span-12"> <label for="modal-form-1"
                                                                     class="form-label">Isi</label>
                                                                 <textarea name="isi_activities" class="form-control" id="" cols="30" rows="5"><?php echo $data['isi_activities']; ?></textarea>

                                                             </div>
                                                             <div class="col-span-12 sm:col-span-12"> <label for="modal-form-1"
                                                                     class="form-label">Tanggal</label>
                                                                 <input id="modal-form-1" type="date"
                                                                     name="tanggal_activities" class="form-control"
                                                                     placeholder="" value="<?php echo $data['tanggal_activities']; ?>">

                                                             </div>
                                                             <div class="col-span-12 sm:col-span-12"> <label for="modal-form-1"
                                                                     class="form-label">Lokasi</label>
                                                                 <input id="modal-form-1" type="text"
                                                                     name="lokasi_activities" class="form-control"
                                                                     placeholder="Lokasi" value="<?php echo $data['lokasi_activities']; ?>">

                                                             </div>
                                                             <div class="col-span-12 sm:col-span-12"> <label for="modal-form-1"
                                                                     class="form-label">Gambar</label>
                                                                 <img width="100" src="../admin/uploads/<?php echo $data['gambar_activities'] ?>" alt="">
                                                                 <input type="hidden" name="foto_lama" value="<?php echo $data['gambar_activities'] ?>" id="">
                                                                 <input type="file" name="gambar_activities" class="form-control"
                                                                     value="<?php echo $data['gambar_activities'] ?>">
                                                             </div>
                                         ...
                                         <div id="delete-confirmation-modal-<?php echo $data['id_activities']; ?>" class="modal" tabindex="-1"
                                             aria-hidden="true">
                                             <div class="modal-dialog">
                                                 <div class="modal-content">
                                                     <div class="modal-body p-0">
                                                         ...
                                                         <div class="px-5 pb-8 text-center">
                                                             ...
                                                             <a href="activities/hapus.php?id_activities=<?php echo $data['id_activities'] ?>"
     ...
     <div id="header-footer-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
         <div class="modal-dialog">
             <div class="modal-content"> <!-- BEGIN: Modal Header -->
                 <div class="modal-header">
                     <h2 class="font-medium text-base mr-auto">Tambah Data Activities</h2>

                 </div> <!-- END: Modal Header --> <!-- BEGIN: Modal Body -->
                 <form action="activities/proses_tambah.php" method="POST" id="myForm1"
                     ...
                     <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                         ...
                         <div class="col-span-12 sm:col-span-12"> <label for="modal-form-1"
                                 class="form-label">Isi</label>
                             <textarea name="isi_activities" class="form-control" id="" cols="30" rows="5"></textarea>
                             <span class="error-message text-danger"></span>
                         </div>
                         <div class="col-span-12 sm:col-span-12"> <label for="modal-form-1"
                                 class="form-label">Tanggal</label>
